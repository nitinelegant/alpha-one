...
const comparisons = [
  { label: "Annualized Return", value1: "15.7%", value2: "14.2%" },
  { label: "Drawdown", value1: "8.2%", value2: "9.1%" },
  { label: "Sharpe Ratio", value1: "1.8", value2: "1.6" },
  { label: "Win Rate", value1: "68%", value2: "65%" },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 pt-24">
        ...
        >
          <h1 className="text-4xl font-bold mb-8 font-funnel">Strategy Comparison</h1>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {comparisons.map((comparison) => (
              <Card key={comparison.label} className="glass-card">
                <CardContent className="p-6">
                  <p className="text-sm text-gray-400 font-funnel">{comparison.label}</p>
          ...
          <Card className="glass-card p-6">
            <h2 className="text-xl font-bold mb-4 font-funnel">Performance Comparison</h2>
